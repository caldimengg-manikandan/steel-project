            ...
            return {
                ...
                corStatus: p.corStatus ? {
                    ...
                    statusSummary: {
                        ...
                        Declined: (p.corStatus.statusSummary?.Declined || 0) + (p.corStatus.statusSummary?.Cancelled || 0) + (p.corStatus.statusSummary?.Void || 0) + (p.corStatus.statusSummary?.Voided || 0)
                    },
